...
static time_t ny_runtime_latest_mtime(const char *root) {
  ...
  static const char *const deps[] = {
      "src/code/runtime/init.c",      "src/code/runtime/ast.c",      "src/code/runtime/bigint.c",
      "src/code/runtime/core.c",      "src/code/runtime/ffi.c",      "src/code/runtime/ffigates.c",
      "src/code/runtime/gc.c",        "src/code/runtime/math.c",     "src/code/runtime/memory.c",
      "src/code/runtime/os.c",        "src/code/runtime/simmd.c",
      "src/code/runtime/string.c",    "src/code/runtime/shared.h",   "src/code/runtime/runtime.h",
      "src/code/runtime/defs.h",      "src/code/parse/ast.h",   "src/code/parse/json.h",
      "src/code/parse/parser.h", "src/code/parse/lexer.h", "src/code/typing/types.h",
