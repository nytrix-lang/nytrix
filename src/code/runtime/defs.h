...
RT_DEF("__malloc", rt_malloc, 1, "fn __malloc(n)",
       "Allocates n bytes of memory on the heap.")
RT_DEF("__free", rt_free, 1, "fn __free(p)",
       "Frees memory previously allocated by rt_malloc.")
RT_DEF("__ptr_add", rt_ptr_add, 2, "fn __ptr_add(p, offset)",
       "Adds a byte offset to a raw pointer.")
RT_DEF("__ptr_sub", rt_ptr_sub, 2, "fn __ptr_sub(p, offset)",
       "Subtracts a byte offset from a raw pointer.")
RT_DEF("__malloc_raw", rt_malloc_raw, 1, "fn __malloc_raw(n)",
       "Allocates unmanaged raw bytes.")
RT_DEF("__free_raw", rt_free_raw, 1, "fn __free_raw(p)",
       "Frees unmanaged raw bytes.")
...
RT_DEF("__release_owned", rt_release_owned, 1, "fn __release_owned(p)",
       "Releases an owned heap value in RC heap mode, freeing it when the "
       "count reaches zero.")
RT_DEF(
    "__rc_count", rt_rc_count, 1, "fn __rc_count(p)",
    "Returns the current RC count for a heap value, for tests and debugging.")
RT_DEF("__realloc", rt_realloc, 2, "fn __realloc(p, n)",
...
RT_DEF("__atomic_add64", rt_atomic_add64, 3, "fn __atomic_add64(p, i, delta)",
       "Atomically adds integer delta to the Ny integer slot at address p + i "
       "and returns the old value.")
RT_DEF("__atomic_sub64", rt_atomic_sub64, 3, "fn __atomic_sub64(p, i, delta)",
       "Atomically subtracts integer delta from the Ny integer slot at address "
       "p + i and returns the old value.")
RT_DEF("__atomic_exchange64", rt_atomic_exchange64, 3,
       "fn __atomic_exchange64(p, i, v)",
       "Atomically exchanges the 64-bit Ny value at address p + i and returns "
       "the old value.")
RT_DEF("__atomic_cas64", rt_atomic_cas64, 4,
       "fn __atomic_cas64(p, i, expected, desired)",
...
RT_DEF("__save_tga_rgba", rt_save_tga_rgba, 5,
       ...
       "buffer.")
RT_DEF("__open", rt_open, 3, "fn __open(path, flags, mode)",
       "Portable open(2) wrapper.")
RT_DEF("__close", rt_close, 1, "fn __close(fd)", "Portable close(2) wrapper.")
RT_DEF("__ioctl", rt_ioctl, 3, "fn __ioctl(fd, req, arg)",
...
RT_DEF("__nanosleep", rt_nanosleep, 1, "fn __nanosleep(ts)",
       "Portable nanosleep wrapper.")
RT_DEF("__time_seconds", rt_time_seconds, 0, "fn __time_seconds()",
       "Returns Unix seconds.")
RT_DEF("__time_milliseconds", rt_time_milliseconds, 0,
       "fn __time_milliseconds()", "Returns Unix milliseconds.")
RT_DEF("__ticks_ns", rt_ticks_ns, 0, "fn __ticks_ns()",
       "Returns monotonic nanoseconds.")
RT_DEF("__msleep_ms", rt_msleep_ms, 1, "fn __msleep_ms(ms)",
       "Sleeps for milliseconds.")
RT_DEF("__web_fetch", rt_web_fetch, 1, "fn __web_fetch(url)",
       "Fetches a browser URL through the web host bridge; native hosts return "
       "failure.")
RT_DEF("__web_clipboard_write", rt_web_clipboard_write, 1,
       "fn __web_clipboard_write(text)",
       "Writes browser clipboard text; native hosts return failure.")
RT_DEF("__web_clipboard_read", rt_web_clipboard_read, 0,
       "fn __web_clipboard_read()",
       "Reads browser clipboard text; native hosts return failure.")
RT_DEF("__websocket_open", rt_websocket_open, 1, "fn __websocket_open(url)",
       "Opens a browser WebSocket; native hosts return failure.")
RT_DEF("__websocket_state", rt_websocket_state, 1,
       "fn __websocket_state(handle)", "Returns browser WebSocket state.")
RT_DEF("__websocket_send", rt_websocket_send, 2,
       "fn __websocket_send(handle, text)",
       "Sends text over a browser WebSocket.")
RT_DEF("__websocket_receive", rt_websocket_receive, 1,
       "fn __websocket_receive(handle)",
       "Receives the next browser WebSocket message.")
RT_DEF("__websocket_close", rt_websocket_close, 1,
       "fn __websocket_close(handle)", "Closes a browser WebSocket.")
RT_DEF("__getpid", rt_getpid, 0, "fn __getpid()", "Portable getpid wrapper.")
RT_DEF("__getppid", rt_getppid, 0, "fn __getppid()",
       "Portable getppid wrapper.")
...
RT_DEF("__getcwd", rt_getcwd, 2, "fn __getcwd(buf, size)",
       "Portable getcwd wrapper.")
RT_DEF("__access", rt_access, 2, "fn __access(path, mode)",
       "Portable access wrapper.")
RT_DEF("__unlink", rt_unlink, 1, "fn __unlink(path)",
       "Portable unlink wrapper.")
RT_DEF("__rename", rt_rename, 2, "fn __rename(old_path, new_path)",
...
RT_DEF("__dup2", rt_dup2, 2, "fn __dup2(oldfd, newfd)",
       "Portable dup2 wrapper.")
RT_DEF("__fork", rt_fork, 0, "fn __fork()",
       "Portable fork wrapper (non-Windows).")
RT_DEF("__setsid", rt_setsid, 0, "fn __setsid()",
...
RT_DEF("__terminal_size_raw", rt_terminal_size_raw, 0,
       "fn __terminal_size_raw()",
       "Returns terminal width and height as a raw native list.")
RT_DEF("__color_raw", rt_color_raw, 2, "fn __color_raw(text, color)",
       "Wraps raw native text with an ANSI foreground color.")
RT_DEF("__bytes_get_raw", rt_bytes_get_raw, 3,
       "fn __bytes_get_raw(buffer, index, fallback)",
       "Reads a bounded byte from a native bytes buffer.")
RT_DEF("__bytes_set_raw", rt_bytes_set_raw, 3,
       "fn __bytes_set_raw(buffer, index, value)",
       "Writes a bounded byte to a native bytes buffer.")
RT_DEF("__args_raw", rt_args_raw, 0, "fn __args_raw()",
       "Returns argv as a raw native list.")
RT_DEF("__canvas", rt_canvas, 2,
       "fn __canvas(width, height)",
       "Creates an opaque native terminal canvas.")
RT_DEF("__canvas_clear", rt_canvas_clear, 1,
       "fn __canvas_clear(canvas)", "Clears an opaque terminal canvas.")
RT_DEF("__canvas_set", rt_canvas_set, 6,
       "fn __canvas_set(canvas, x, y, ch, color, bold)",
       "Updates an opaque native terminal canvas.")
RT_DEF("__canvas_refresh", rt_canvas_refresh, 1,
       "fn __canvas_refresh(canvas)",
       "Refreshes an opaque native canvas.")
RT_DEF("__tui_canvas_loop", rt_tui_canvas_loop, 1,
       "fn __tui_canvas_loop(draw)",
       "Native compile-safe TUI loop shim.")
RT_DEF("__sound_init", rt_sound_init, 1,
       "fn __sound_init(force_async)",
       "Reports unavailable native sound backend.")
RT_DEF("__tui_begin", rt_tui_begin, 0, "fn __tui_begin()",
       "Enters compile-safe native TUI mode.")
RT_DEF("__tui_end", rt_tui_end, 0, "fn __tui_end()",
       "Leaves compile-safe native TUI mode.")
RT_DEF("__poll_key", rt_poll_key, 0, "fn __poll_key()",
       "Returns no key from the compile-safe native TUI input shim.")
RT_DEF("__file_exists", rt_file_exists, 1, "fn __file_exists(path)",
       "Returns whether a native filesystem path exists.")
RT_DEF("__sound_backend_name", rt_sound_backend_name, 0,
       "fn __sound_backend_name()",
       "Returns the unavailable native sound backend name.")
RT_DEF("__sound_noop", rt_sound_noop, 1,
       "fn __sound_noop(value)",
       "Compile-safe native sound operation shim.")
RT_DEF("__is_dir", rt_is_dir, 1, "fn __is_dir(path)",
       "Portable directory check.")

RT_DEF("__dir_open", rt_dir_open, 1, "fn __dir_open(path)",
       "Open directory handle.")
RT_DEF("__dir_read", rt_dir_read, 1, "fn __dir_read(handle)",
       "Read next directory entry.")
RT_DEF("__dir_close", rt_dir_close, 1, "fn __dir_close(handle)",
       "Close directory handle.")

RT_DEF("__inotify_init", rt_inotify_init, 1, "fn __inotify_init(flags)",
       "inotify_init1 or inotify_init wrapper for file watching.")
RT_DEF("__inotify_add_watch", rt_inotify_add_watch, 3,
       "fn __inotify_add_watch(fd, path, mask)",
       "Add inotify watch for path with mask.")
RT_DEF("__inotify_rm_watch", rt_inotify_rm_watch, 2,
       "fn __inotify_rm_watch(fd, wd)", "Remove inotify watch.")

RT_DEF("__kqueue", rt_kqueue, 0, "fn __kqueue()",
       "Create a kqueue (macOS/BSD) for file watching.")
RT_DEF("__kevent", rt_kevent, 7,
       "fn __kevent(kq, fd, filter, flags, fflags, data, udata)",
       "kevent call for registering/reading vnode events.")
RT_DEF("__kqueue_close", rt_kqueue_close, 1, "fn __kqueue_close(kq)",
       "Close kqueue fd.")
RT_DEF("__watch_open_vnode", rt_watch_open_vnode, 1,
       "fn __watch_open_vnode(path)",
       "Open a file/dir fd suitable for kqueue vnode watching (macOS).")

RT_DEF("__win32_find_first_change", rt_win32_find_first_change, 3,
       "fn __win32_find_first_change(path, watch_subtree, filter)",
       "Windows FindFirstChangeNotification.")
RT_DEF("__win32_find_next_change", rt_win32_find_next_change, 1,
       "fn __win32_find_next_change(handle)",
       "Windows FindNextChangeNotification.")
RT_DEF("__win32_find_close_change", rt_win32_find_close_change, 1,
       "fn __win32_find_close_change(handle)",
       "Windows FindCloseChangeNotification.")
...
RT_DEF("__bigint_submul", rt_bigint_submul, 3, "fn __bigint_submul(a, q, b)",
       "Computes a - q*b for BigInt-heavy arithmetic without materializing the "
       "product.")
RT_DEF("__bigint_row_submul", rt_bigint_row_submul, 4,
       "fn __bigint_row_submul(row_k, row_j, q, limit)",
...
RT_DEF("__bigint_or", rt_bigint_or, 2, "fn __bigint_or(a, b)",
       "Computes bitwise OR for non-negative BigInts using the runtime bigint "
       "implementation.")
RT_DEF("__bigint_xor", rt_bigint_xor, 2, "fn __bigint_xor(a, b)",
       "Computes bitwise XOR for non-negative BigInts using the runtime bigint "
       "implementation.")
RT_DEF(
    "__bigint_and", rt_bigint_and, 2, "fn __bigint_and(a, b)",
...
RT_DEF("__bigint_not", rt_bigint_not, 1, "fn __bigint_not(a)",
       "Computes bitwise complement (~a = -a - 1) using the runtime bigint "
       "implementation.")
...
RT_DEF("__bigint_powmod", rt_bigint_powmod, 3, "fn __bigint_powmod(a, b, m)",
       ...
       "implementation.")
RT_DEF(
    "__bigint_modinv", rt_bigint_modinv, 2, "fn __bigint_modinv(a, m)",
...
RT_DEF("__bigint_f64buf_store", rt_bigint_f64buf_store, 3,
       "fn __bigint_f64buf_store(buf, i, a)",
...
RT_DEF("__long", rt_long, 1, "fn __long(a)",
       "Converts ints, floats, BigInts, byte lists, strings, and bytes buffers "
       "to BigInt.")
...
RT_DEF("__bigint_kronecker", rt_bigint_kronecker, 2,
       "fn __bigint_kronecker(a, n)", "Kronecker symbol (a/n) using GMP.")
...
RT_DEF("__bigint_is_perfect_square", rt_bigint_is_perfect_square, 1,
       "fn __bigint_is_perfect_square(n)",
...
RT_DEF("__bigint_gf2_mulmod", rt_bigint_gf2_mulmod, 3,
       "fn __bigint_gf2_mulmod(a, b, m)",
...
RT_DEF("__ct_select", rt_ct_select, 3, "fn __ct_select(a, b, condition)",
       ...
       "without branching.")
RT_DEF("__write_buffered", rt_write_buffered, 3,
       "fn __write_buffered(fd, buf, len)",
...
RT_DEF("__socket", rt_socket, 3, "fn __socket(domain, type, protocol)",
       "Portable socket wrapper.")
RT_DEF("__connect", rt_connect, 3, "fn __connect(fd, addr, addrlen)",
       "Portable connect wrapper.")
RT_DEF("__bind", rt_bind, 3, "fn __bind(fd, addr, addrlen)",
       "Portable bind wrapper.")
RT_DEF("__listen", rt_listen, 2, "fn __listen(fd, backlog)",
       "Portable listen wrapper.")
RT_DEF("__accept", rt_accept, 3, "fn __accept(fd, addr, addrlen)",
       "Portable accept wrapper.")
RT_DEF("__sendto", rt_sendto, 6,
       "fn __sendto(fd, buf, len, flags, addr, addrlen)",
       "Portable sendto wrapper.")
RT_DEF("__recvfrom", rt_recvfrom, 6,
       "fn __recvfrom(fd, buf, len, flags, addr, addrlen)",
       "Portable recvfrom wrapper.")
RT_DEF("__setsockopt", rt_setsockopt, 5,
       "fn __setsockopt(fd, level, optname, optval, optlen)",
       "Portable setsockopt wrapper.")
RT_DEF("__recv", rt_recv, 4, "fn __recv(fd, buf, len, flags)",
       "Portable recv wrapper.")
RT_DEF("__send", rt_send, 4, "fn __send(fd, buf, len, flags)",
       "Portable send wrapper.")
RT_DEF("__closesocket", rt_closesocket, 1, "fn __closesocket(fd)",
       "Portable socket close wrapper.")
RT_DEF("__async_task_new", rt_async_task_new, 3,
       "fn __async_task_new(fn, argc, argv)",
       "Creates a stackless async task from a callable and copied argument "
       "vector.")
...
RT_DEF(
    "__async_await_blocking", rt_async_await_blocking, 1,
    "fn __async_await_blocking(task)",
...
RT_DEF("__async_wait_fd", rt_async_wait_fd, 3,
       "fn __async_wait_fd(fd, events, timeout_ms)",
...
RT_DEF("__async_connect", rt_async_connect, 3,
       "fn __async_connect(fd, addr, addrlen)",
       "Creates a non-blocking socket connect task.")
RT_DEF("__async_read_socket", rt_async_read_socket, 2,
       "fn __async_read_socket(fd, max_len)",
...
RT_DEF("__execve", rt_execve, 3, "fn __execve(path, argv, envp)",
...
RT_DEF("__is_nil", rt_is_nil, 1, "fn __is_nil(v)",
       "Checks if value is the nil immediate.")
RT_DEF("__is_int", rt_is_int, 1, "fn __is_int(v)",
       "Checks if value is a tagged integer.")
RT_DEF("__is_ptr", rt_is_ptr, 1, "fn __is_ptr(v)",
...
RT_DEF("__tagof", rt_tagof, 1, "fn __tagof(v)",
       "Returns the raw runtime tag stored at v-8, or 0.")
RT_DEF("__type_name", rt_type_name, 1, "fn __type_name(v)",
       "Returns a native C-string type name.")
RT_DEF("__type_name_tagged", rt_type_name_tagged, 2,
       "fn __type_name_tagged(v, tag)",
       "Returns a native C-string type name using an explicit dynamic tag.")
...
RT_DEF("__str_len", rt_cstr_len, 1, "fn __str_len(s)",
       "Returns byte length of string/cstr.")
...
RT_DEF("__list_new", rt_list_new, 1, "fn __list_new(n)",
       "Allocates an empty list with capacity n.")
RT_DEF("__load_item", rt_load_item, 2, "fn __load_item(lst, i)",
...
RT_DEF("__load_item_any", rt_load_item_any, 2, "fn __load_item_any(lst, i)",
       "Loads and canonicalizes a dynamic list element.")
RT_DEF("__store_item_fast", rt_store_item_fast, 3,
...
RT_DEF("__append", rt_append, 2, "fn __append(lst, v)",
...
RT_DEF("__list_sum_int_range", rt_list_sum_int_range, 3,
       "fn __list_sum_int_range(lst, start, stop) int",
...
RT_DEF("__dict_get_raw", rt_dict_get_raw, 3,
       "fn __dict_get_raw(d, key, default)",
       "Looks up a non-string key in a native-layout dictionary.")
RT_DEF("__dict_get_i64_raw", rt_dict_get_i64_raw, 3,
       "fn __dict_get_i64_raw(d, key, default)",
       "Looks up a proven raw integer key in a native-layout dictionary.")
RT_DEF("__dict_get_str_raw", rt_dict_get_str_raw, 3,
       "fn __dict_get_str_raw(d, key, default)",
       "Looks up a string key in a native-layout dictionary.")
RT_DEF("__dict_set_raw", rt_dict_set_raw, 3,
       "fn __dict_set_raw(d, key, value)",
       "Inserts or updates a non-string key in a native-layout dictionary.")
RT_DEF("__dict_set_i64_raw", rt_dict_set_i64_raw, 3,
       "fn __dict_set_i64_raw(d, key, value)",
       "Inserts or updates a proven raw integer key in a native-layout "
       "dictionary.")
RT_DEF("__dict_set_str_raw", rt_dict_set_str_raw, 3,
       "fn __dict_set_str_raw(d, key, value)",
       "Inserts or updates a string key in a native-layout dictionary.")
RT_DEF("__dict_has_raw", rt_dict_has_raw, 2, "fn __dict_has_raw(d, key)",
       "Checks a non-string key in a native-layout dictionary.")
RT_DEF("__dict_has_str_raw", rt_dict_has_str_raw, 2,
       "fn __dict_has_str_raw(d, key)",
       "Checks a string key in a native-layout dictionary.")
RT_DEF("__dict_len_raw", rt_dict_len_raw, 1, "fn __dict_len_raw(d)",
       "Returns the element count of a native-layout dictionary.")
RT_DEF("__dict_delete_raw", rt_dict_delete_raw, 2,
       "fn __dict_delete_raw(d, key)",
       "Deletes a non-string key from a native-layout dictionary.")
RT_DEF("__dict_delete_str_raw", rt_dict_delete_str_raw, 2,
       "fn __dict_delete_str_raw(d, key)",
       "Deletes a string key from a native-layout dictionary.")
RT_DEF("__dict_clone_raw", rt_dict_clone_raw, 1,
       "fn __dict_clone_raw(d)",
       "Creates a shallow copy of a native-layout dictionary.")
RT_DEF("__dict_clear_raw", rt_dict_clear_raw, 1,
       "fn __dict_clear_raw(d)",
       "Removes all entries from a native-layout dictionary.")
RT_DEF("__dict_merge_raw", rt_dict_merge_raw, 2,
       "fn __dict_merge_raw(dst, src)",
       "Merges src into dst, both native-layout dictionaries.")
RT_DEF("__dict_keys_raw", rt_dict_keys_raw, 1, "fn __dict_keys_raw(d)",
       "Returns a list of keys from a native-layout dictionary.")
RT_DEF("__dict_values_raw", rt_dict_values_raw, 1,
       "fn __dict_values_raw(d)",
       "Returns a list of values from a native-layout dictionary.")
RT_DEF("__dict_items_raw", rt_dict_items_raw, 1,
       "fn __dict_items_raw(d)",
...
RT_DEF("__tbuf_index_any_raw", rt_tbuf_index_any_raw, 2,
       "fn __tbuf_index_any_raw(buffer, index)",
...
RT_DEF("__flt_mul", rt_flt_mul, 2, "fn __flt_mul(a, b)",
...
RT_DEF("__flt_is_nan", rt_flt_is_nan, 1, "fn __flt_is_nan(f)",
       "Returns true for NaN floats.")
RT_DEF("__flt_is_inf", rt_flt_is_inf, 1, "fn __flt_is_inf(f)",
       "Returns true for infinite floats.")
RT_DEF("__flt_nan", rt_flt_nan, 0, "fn __flt_nan()", "Returns a NaN float.")
RT_DEF("__flt_inf", rt_flt_inf, 0, "fn __flt_inf()",
       "Returns positive infinity.")
RT_DEF("__flt_hash", rt_flt_hash, 1, "fn __flt_hash(f)",
       "Returns a stable integer hash for a float.")
...
RT_DEF("__flt_atan2", rt_flt_atan2, 2, "fn __flt_atan2(y, x)",
       "Float arctangent with quadrant handling.")
...
RT_DEF("__flt_log", rt_flt_log, 1, "fn __flt_log(x)",
       "Float natural logarithm.")
RT_DEF("__flt_log2", rt_flt_log2, 1, "fn __flt_log2(x)",
       "Float base-2 logarithm.")
RT_DEF("__flt_log10", rt_flt_log10, 1, "fn __flt_log10(x)",
       "Float base-10 logarithm.")
RT_DEF("__flt_floor", rt_flt_floor, 1, "fn __flt_floor(x)",
       "Float floor as integer.")
RT_DEF("__flt_ceil", rt_flt_ceil, 1, "fn __flt_ceil(x)",
       "Float ceil as integer.")
RT_DEF("__flt_round", rt_flt_round, 1, "fn __flt_round(x)",
       "Float round as integer.")
...
RT_DEF("__flt_from_int", rt_flt_from_int, 1, "fn __flt_from_int(i)",
       "Convert int to float.")
RT_DEF("__flt_to_int", rt_flt_to_int, 1, "fn __flt_to_int(f)",
       "Convert float to int.")
RT_DEF("__flt_trunc", rt_flt_trunc, 1, "fn __flt_trunc(f)",
...
RT_DEF("__complex_new_bits", rt_complex_new_bits, 2,
       "fn __complex_new_bits(re_bits, im_bits)",
...
RT_DEF("__complex_add", rt_complex_add, 2, "fn __complex_add(a, b)",
       "Complex addition.")
RT_DEF("__complex_sub", rt_complex_sub, 2, "fn __complex_sub(a, b)",
       "Complex subtraction.")
RT_DEF("__complex_mul", rt_complex_mul, 2, "fn __complex_mul(a, b)",
       "Complex multiplication.")
RT_DEF("__complex_div", rt_complex_div, 2, "fn __complex_div(a, b)",
       "Complex division.")
RT_DEF("__complex_conj", rt_complex_conj, 1, "fn __complex_conj(z)",
       "Complex conjugate.")
RT_DEF("__complex_abs2", rt_complex_abs2, 1, "fn __complex_abs2(z)",
       "Squared complex magnitude.")
RT_DEF("__complex_eq", rt_complex_eq, 2, "fn __complex_eq(a, b)",
       "Complex equality.")

RT_DEF("__dlsym", rt_dlsym, 2, "fn __dlsym(handle, symbol)",
       "Resolves a symbol in a library.")
RT_DEF("__dlopen", rt_dlopen, 2, "fn __dlopen(path, flags)",
       "Opens a dynamic library.")
RT_DEF("__dlclose", rt_dlclose, 1, "fn __dlclose(handle)",
       "Closes a dynamic library.")
RT_DEF("__dlerror", rt_dlerror, 0, "fn __dlerror()",
       "Returns the last dynamic linking error.")
RT_DEF("__zlib_uncompress", rt_zlib_uncompress, 4,
       "fn __zlib_uncompress(dest, destLen_p, src, srcLen)",
       "Decompresses zlib data.")
RT_DEF("__zlib_compress", rt_zlib_compress, 5,
       "fn __zlib_compress(dest, destLen_p, src, srcLen, level)",
       "Compresses data to zlib format.")
RT_DEF("__zlib_compress_str", rt_zlib_compress_str, 3,
       "fn __zlib_compress_str(src, srcLen, level)",
       "Compresses data to a Nytrix string.")
...
RT_DEF("__call2", rt_call2, 3, "fn __call2(fptr, a, b)",
       "Call fptr with 2 args.")
RT_DEF("__call_any1", rt_call_any1, 2, "fn __call_any1(fptr, value)",
       "Call a native Nytrix callback with one dynamic any argument.")
RT_DEF("__call_any2", rt_call_any2, 3, "fn __call_any2(fptr, left, right)",
       "Call a native Nytrix callback with two dynamic any arguments.")
...
RT_DEF("__call3", rt_call3, 4, "fn __call3(fptr, a, b, c)",
...
RT_DEF("__call3_ptr_u64_ptr", rt_call3_ptr_u64_ptr, 4,
       "fn __call3_ptr_u64_ptr(fptr, a, b, c)",
       "Call fptr(ptr, u64, ptr) and return a native pointer handle.")
RT_DEF("__call3_ptr_u32_ptr", rt_call3_ptr_u32_ptr, 4,
       "fn __call3_ptr_u32_ptr(fptr, a, b, c)",
       "Call fptr(ptr, u32, ptr) and return a native pointer handle.")
RT_DEF("__call3_ptr_ptr_u32", rt_call3_ptr_ptr_u32, 4,
       "fn __call3_ptr_ptr_u32(fptr, a, b, c)",
       "Call fptr(ptr, ptr, u32) and return a native pointer handle.")
RT_DEF("__call4", rt_call4, 5, "fn __call4(fptr, a, b, c, d)",
...
RT_DEF("__call3_ptr_u64_ptr_i32", rt_call3_ptr_u64_ptr_i32, 4,
       "fn __call3_ptr_u64_ptr_i32(fptr, a, b, c)",
       "Call fptr(ptr, u64, ptr) and return i32.")
...
RT_DEF("__call2_f32_void", rt_call2_f32_void, 3,
       "fn __call2_f32_void(fptr, a, b)", "Call fptr with 2 float args.")
RT_DEF("__call3_f32_void", rt_call3_f32_void, 4,
       "fn __call3_f32_void(fptr, a, b, c)", "Call fptr with 3 float args.")
RT_DEF("__call4_f32_void", rt_call4_f32_void, 5,
...
RT_DEF("__call5", rt_call5, 6, "fn __call5(fptr, a, b, c, d, e)",
...
RT_DEF("__call6", rt_call6, 7, "fn __call6(fptr, a, b, c, d, e, f)",
       "Call fptr with 6 args.")
RT_DEF("__call7", rt_call7, 8, "fn __call7(fptr, ...)",
       "Call fptr with 7 args.")
RT_DEF("__call7_void", rt_call7_void, 8, "fn __call7_void(fptr, ...)",
       "Call fptr with seven arguments and no return value.")
RT_DEF("__call8", rt_call8, 9, "fn __call8(fptr, ...)",
       "Call fptr with 8 args.")
RT_DEF("__call9", rt_call9, 10, "fn __call9(fptr, ...)",
...
RT_DEF("__call10", rt_call10, 11, "fn __call10(fptr, ...)",
       "Call fptr with 10 args.")
RT_DEF("__call11", rt_call11, 12, "fn __call11(fptr, ...)",
       "Call fptr with 11 args.")
RT_DEF("__call12", rt_call12, 13, "fn __call12(fptr, ...)",
       "Call fptr with 12 args.")
RT_DEF("__call13", rt_call13, 14, "fn __call13(fptr, ...)",
       "Call fptr with 13 args.")
RT_DEF("__call14", rt_call14, 15, "fn __call14(fptr, ...)",
       "Call fptr with 14 args.")
RT_DEF("__call15", rt_call15, 16, "fn __call15(fptr, ...)",
       "Call fptr with 15 args.")
RT_DEF("__set_args", rt_set_args, 3, "fn __set_args(ac, av, ep)",
       "Initialize command line arguments.")
RT_DEF("__parse_ast", rt_parse_ast, 1, "fn __parse_ast(s)",
...
RT_DEF("__index_read_probe_enabled", rt_index_read_probe_enabled, 0,
       "fn __index_read_probe_enabled()",
       "Internal: returns true when index parity probe logging is enabled.")
RT_DEF("__index_read_probe", rt_index_read_probe, 3,
       "fn __index_read_probe(tag, idx, path)",
...
RT_DEF("__trace_enter", rt_trace_enter, 3,
       "fn __trace_enter(func, file, line) int",
...
RT_DEF("__trace_ret_f64_bits", rt_trace_ret_f64_bits, 1,
       "fn __trace_ret_f64_bits(v)",
...
RT_DEF("__get_backtrace", rt_get_backtrace, 1, "fn __get_backtrace(n)",
       ...
       "func] frames.")
RT_DEF("__push_defer", rt_push_defer, 2, "fn __push_defer(f, e)",
       "Internal: push defer.")
RT_DEF("__pop_run_defer", rt_pop_run_defer, 0, "fn __pop_run_defer()",
       "Internal: pop and run one defer.")
RT_DEF("__run_defers_to", rt_run_defers_to, 1, "fn __run_defers_to(n)",
       "Internal: run defers.")

RT_DEF("__argc", rt_argc, 0, "fn __argc()",
       "Returns the number of command-line arguments.")
RT_DEF("__argvp", rt_argvp, 0, "fn __argvp()", "Returns the raw argv pointer.")
RT_DEF("__argv", rt_argv, 1, "fn __argv(i)",
       "Returns the command-line argument string at index i.")
RT_DEF("__envc", rt_envc, 0, "fn __envc()",
       "Returns the number of environment variables.")
RT_DEF("__envp", rt_envp, 0, "fn __envp()",
       "Returns the raw environment variables pointer.")
RT_DEF(
    "__env_get", rt_env_get, 1, "fn __env_get(key)",
    "Returns an environment value as a native-safe string, or nil when absent.")
RT_DEF("__argv_get", rt_argv_get, 1, "fn __argv_get(i)",
       "Returns argv index i using the native raw-index ABI.")
RT_DEF("__envc_raw", rt_envc_raw, 0, "fn __envc_raw()",
       "Returns the environment count using the native raw integer ABI.")
RT_DEF("__errno", rt_errno, 0, "fn __errno()", "Returns the last error number.")
RT_DEF("__result_ok", rt_result_ok, 1, "fn __result_ok(v)",
       "Creates an Ok result.")
RT_DEF("__result_err", rt_result_err, 1, "fn __result_err(e)",
       "Creates an Err result.")
RT_DEF("__is_ok", rt_is_ok, 1, "fn __is_ok(v)",
       "Checks if value is an Ok result.")
RT_DEF("__is_err", rt_is_err, 1, "fn __is_err(v)",
       "Checks if value is an Err result.")
RT_DEF("__unwrap", rt_unwrap, 1, "fn __unwrap(v)",
       "Unwraps a Result or returns the value.")

RT_DEF("__thread_spawn_raw", rt_thread_spawn_raw, 2,
       "fn __thread_spawn_raw(fn, arg)",
       "Spawns an LLVM-free native callback with raw arguments.")

RT_DEF("__thread_spawn", rt_thread_spawn, 2, "fn __thread_spawn(fn, arg)",
       "Spawns a new thread.")
RT_DEF("__thread_spawn_call", rt_thread_spawn_call, 3,
       "fn __thread_spawn_call(fn, argc, argv)",
       "Spawns a new thread and invokes fn with argc arguments from argv.")
RT_DEF("__thread_launch_call", rt_thread_launch_call, 3,
       "fn __thread_launch_call(fn, argc, argv)",
       "Launches a detached thread and invokes fn with argc arguments.")
RT_DEF("__thread_join", rt_thread_join, 1, "fn __thread_join(t)",
       "Joins a thread.")
RT_DEF("__mutex_new", rt_mutex_new, 0, "fn __mutex_new()",
       "Creates a new mutex.")
RT_DEF("__mutex_lock64", rt_mutex_lock64, 1, "fn __mutex_lock64(m)",
       "Locks a mutex.")
RT_DEF("__mutex_unlock64", rt_mutex_unlock64, 1, "fn __mutex_unlock64(m)",
       "Unlocks a mutex.")
RT_DEF("__mutex_free", rt_mutex_free, 1, "fn __mutex_free(m)", "Frees a mutex.")

RT_DEF("__to_str", rt_to_str, 1, "fn __to_str(v)",
...
RT_DEF("__str_concat", rt_str_concat, 2, "fn __str_concat(a, b)",
       "Concatenates two strings.")
RT_DEF("__str_builder_new", rt_str_builder_new, 1, "fn __str_builder_new(cap)",
       "Creates an internal string builder.")
RT_DEF("__str_builder_append", rt_str_builder_append, 2,
       "fn __str_builder_append(builder, value)",
       "Appends a value to an internal string builder.")
RT_DEF("__str_builder_to_str", rt_str_builder_to_str, 1,
       "fn __str_builder_to_str(builder)",
       "Finishes an internal string builder as a string.")
RT_DEF("__str_builder_free", rt_str_builder_free, 1,
       "fn __str_builder_free(builder)", "Frees an internal string builder.")
RT_DEF("__str_hash", rt_str_hash, 1, "fn __str_hash(s)",
       "Hashes a Nytrix string for dictionaries.")
RT_DEF("__str_eq", rt_str_eq, 2, "fn __str_eq(a, b)",
       "Compares two Nytrix strings byte-wise.")
RT_DEF("__proof_cert_digest", rt_proof_cert_digest, 4,
       "fn __proof_cert_digest(canonical, module_version, dependency_digest, "
       "checker_version)",
       "Computes the compact proof-certificate envelope digest.")
RT_DEF("__proof_cert_check", rt_proof_cert_check, 10,
       "fn __proof_cert_check(canonical, digest, module_version, "
       "dependency_digest, checker_version, max_variables, max_nodes, "
       "max_depth, max_steps, max_memory)",
       "Checks a canonical propositional certificate under explicit budgets.")
RT_DEF("__memcpy", rt_memcpy, 3, "fn __memcpy(d, s, n)",
       "Copies n bytes from s to d.")
RT_DEF("__memcmp", rt_memcmp, 3, "fn __memcmp(a, b, n)",
       "Compares n bytes of a and b.")
RT_DEF("__memset", rt_memset, 3, "fn __memset(p, v, n)",
       "Sets n bytes of p to v.")
RT_DEF("__rand64", rt_rand64, 0, "fn __rand64()",
       "Returns a random 64-bit integer.")
RT_DEF("__srand", rt_srand, 1, "fn __srand(s)",
...
RT_DEF("__simmd_has_feature", rt_simmd_has_feature, 1,
       "fn __simmd_has_feature(name)",
       "Returns true when the host/runtime supports a named SIMD or "
       "instruction feature.")
RT_DEF("__simmd_sha256_block", rt_simmd_sha256_block, 2,
       "fn __simmd_sha256_block(state, block)",
       "Processes one SHA-256 block using the best available implementation.")
RT_DEF("__simmd_sha256_blocks", rt_simmd_sha256_blocks, 3,
       "fn __simmd_sha256_blocks(state, blocks, count)",
       "Processes multiple SHA-256 blocks using the best available "
       "implementation.")
...
RT_DEF("__simmd_prefetch", rt_simmd_prefetch, 3,
       "fn __simmd_prefetch(ptr, rw, locality)",
...
RT_DEF(
    "__simmd_crc32_u8", rt_simmd_crc32_u8, 2, "fn __simmd_crc32_u8(crc, byte)",
    "Updates a CRC32C accumulator with one byte, using SSE4.2 when available.")
RT_DEF("__simmd_crc32_u64", rt_simmd_crc32_u64, 2,
       "fn __simmd_crc32_u64(crc, word)",
...
RT_DEF("__simmd_clmul64_lo", rt_simmd_clmul64_lo, 2,
       "fn __simmd_clmul64_lo(x, y)",
       "Low 64 bits of carry-less 64x64 GF(2) multiplication.")
RT_DEF("__simmd_clmul64_hi", rt_simmd_clmul64_hi, 2,
       "fn __simmd_clmul64_hi(x, y)",
...
RT_DEF("__simmd_f32x4_fma_ptr", rt_simmd_f32x4_fma_ptr, 4,
       ...
       "Unaligned 4-lane f32 fused multiply-add from raw pointers where "
       "supported.")
...
RT_DEF("__simmd_f64x2_fma_ptr", rt_simmd_f64x2_fma_ptr, 4,
       ...
       "Unaligned 2-lane f64 fused multiply-add from raw pointers where "
       "supported.")
RT_DEF("__simmd_byte_class_reduce", rt_simmd_byte_class_reduce, 7,
       "fn __simmd_byte_class_reduce(ptr, len, rounds, class_lo, class_hi, "
       "hit, miss)",
       "Counts/reduces bytes against a 128-bit ASCII class mask, using "
       "AVX2/SSE2/NEON when available.")
...
RT_DEF("__simmd_i32_hash_probe_sum_ptr", rt_simmd_i32_hash_probe_sum_ptr, 8,
       "fn __simmd_i32_hash_probe_sum_ptr(keys, values, used, cap, probe_keys, "
       "probe_weights, n, rounds)",
...
RT_DEF("__mat4_from_buffer", rt_mat4_from_buffer, 2,
       "fn __mat4_from_buffer(m, buf)",
       "Optimized conversion of raw float buffer back into 4x4 matrix object.")
RT_DEF("__os_name", rt_os_name, 0, "fn __os_name()",
       "Returns the name of the operating system.")
RT_DEF("__arch_name", rt_arch_name, 0, "fn __arch_name()",
       "Returns the name of the architecture.")
RT_DEF("__main", rt_main, 0, "fn __main()",
...
RT_GV("std.core.primitives.__argc_val", rt_argc_val, int64_t,
      "Global: argc value.")
RT_GV("std.core.primitives.__envc_val", rt_envc_val, int64_t,
      "Global: envc value.")
RT_GV("std.core.primitives.__argv_ptr", rt_argv_ptr, int64_t *,
      "Global: argv pointer.")
RT_GV("std.core.primitives.__envp_ptr", rt_envp_ptr, int64_t *,
      "Global: envp pointer.")
RT_GV("std.core.primitives.__errno_val", rt_errno_val, int64_t,
      "Global: errno value.")
RT_GV("std.core.primitives.__globals_ptr", rt_globals_ptr, int64_t,
      "Global: globals table pointer.")

RT_DEF("__print_int", rt_print_int, 1, "fn __print_int(v)",
       "Fast integer print.")
RT_DEF("__print_newline", rt_print_newline, 0, "fn __print_newline()",
       "Fast newline.")
RT_DEF("__print_str_raw", rt_print_str_raw, 1, "fn __print_str_raw(s)",
       "Fast string print.")
RT_DEF("__print_cstr", rt_print_cstr, 1, "fn __print_cstr(p)",
       "Print null-terminated C string pointer.")
#undef RT_GV
