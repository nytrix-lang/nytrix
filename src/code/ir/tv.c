...
#ifdef NYTRIX_HAS_Z3
static Z3_ast nyir_smt_ror32(Z3_context z3, Z3_ast a, Z3_ast b) {
  Z3_sort word_sort = Z3_mk_bv_sort(z3, 32);
  Z3_ast word = Z3_mk_extract(z3, 31, 0, a);
  Z3_ast count = Z3_mk_extract(z3, 31, 0, b);
  Z3_ast width = Z3_mk_int64(z3, 32, word_sort);
  Z3_ast right = Z3_mk_bvlshr(z3, word, count);
  Z3_ast left = Z3_mk_bvshl(z3, word, Z3_mk_bvsub(z3, width, count));
  return Z3_mk_zero_ext(z3, 32, Z3_mk_bvor(z3, right, left));
}
