...
#linux {
   ...
   #link "libvulkan.so"
   extern "wayland-client" {
      fn _c_wl_proxy_marshal_flags0(ptr proxy, i32 opcode, ptr interface, u32 version, u32 flags) ptr as "wl_proxy_marshal_flags"
      fn _c_wl_proxy_marshal_flags1(ptr proxy, i32 opcode, ptr interface, u32 version, u32 flags, ptr arg0) ptr as "wl_proxy_marshal_flags"
      fn _c_wl_proxy_marshal_flags2(ptr proxy, i32 opcode, ptr interface, u32 version, u32 flags, ptr arg0, ptr arg1) ptr as "wl_proxy_marshal_flags"
      fn _c_wl_proxy_marshal_flags3(ptr proxy, i32 opcode, ptr interface, u32 version, u32 flags, ptr arg0, ptr arg1, ptr arg2) ptr as "wl_proxy_marshal_flags"
      fn _c_wl_proxy_marshal_flags4(ptr proxy, i32 opcode, ptr interface, u32 version, u32 flags, ptr arg0, ptr arg1, ptr arg2, ptr arg3) ptr as "wl_proxy_marshal_flags"
      fn _c_wl_proxy_marshal_flags5(ptr proxy, i32 opcode, ptr interface, u32 version, u32 flags, ptr arg0, ptr arg1, ptr arg2, ptr arg3, ptr arg4) ptr as "wl_proxy_marshal_flags"
      fn wl_proxy_destroy(ptr proxy) any
      fn wl_proxy_add_listener(ptr proxy, ptr implementation, ptr data) i32
      fn wl_display_connect(ptr name) ptr
      fn wl_display_disconnect(ptr display) any
      fn wl_display_flush(ptr display) i32
      fn wl_display_roundtrip(ptr display) i32
      fn wl_display_get_fd(ptr display) i32
      fn wl_display_dispatch_pending(ptr display) i32
      fn wl_display_dispatch(ptr display) i32
      fn wl_display_prepare_read(ptr display) i32
      fn wl_display_read_events(ptr display) i32
      fn wl_display_create_queue(ptr display) ptr
      fn wl_display_cancel_read(ptr display) any
      fn wl_display_prepare_read_queue(ptr display, ptr queue) i32
      fn wl_display_dispatch_queue_pending(ptr display, ptr queue) i32
      fn wl_event_queue_destroy(ptr queue) any
      fn wl_proxy_create_wrapper(ptr proxy) ptr
      fn wl_proxy_get_user_data(ptr proxy) ptr
      fn wl_proxy_get_version(ptr proxy) u32
      fn wl_proxy_set_queue(ptr proxy, ptr queue) any
      fn wl_proxy_set_user_data(ptr proxy, ptr user_data) any
      fn wl_proxy_wrapper_destroy(ptr proxy_wrapper) any
   }
   extern "wayland-cursor" {
      fn wl_cursor_theme_load(ptr name, i32 size, ptr shm) ptr
      fn wl_cursor_theme_get_cursor(ptr theme, ptr name) ptr
      fn wl_cursor_theme_destroy(ptr theme) any
      fn wl_cursor_image_get_buffer(ptr image) ptr
   }
   extern "xkbcommon" {
      fn xkb_context_new(i32 flags) ptr
      fn xkb_context_unref(ptr context) any
      fn xkb_keymap_new_from_string(ptr context, ptr string, i32 format, i32 flags) ptr
      fn xkb_keymap_mod_get_index(ptr keymap, ptr name) u32
      fn xkb_keymap_unref(ptr keymap) any
      fn xkb_keysym_get_name(u32 keysym, ptr buffer, u64 size) i32
      fn xkb_keysym_to_utf32(u32 keysym) u32
      fn xkb_state_key_get_one_sym(ptr state, u32 key) u32
      fn xkb_state_key_get_utf8(ptr state, u32 key, ptr buffer, u64 size) i32
      fn xkb_state_mod_index_is_active(ptr state, u32 idx, i32 type) i32
      fn xkb_state_new(ptr keymap) ptr
      fn xkb_state_unref(ptr state) any
      fn xkb_state_update_mask(ptr state, u32 depressed, u32 latched, u32 locked, u32 group, u32 layout_, u32 group_locked) i32
   }
   extern "" {
      fn close(i32 fd) i32
      fn mmap(ptr addr, u64 length, i32 prot, i32 flags, i32 fd, i64 offset) ptr
      fn munmap(ptr addr, u64 length) i32
      fn pipe(ptr fds) i32
      fn poll(ptr fds, u64 nfds, i32 timeout) i32
...
comptime template _wl_marshal_flags_wrap0(name){
   fn ${name}(any proxy, int opcode, any interface, int version, any flags) any {
      #linux { return _c_wl_proxy_marshal_flags0(proxy, opcode, interface, version, flags) }
      #else { return 0 } #endif
   }
}
...
comptime template _wl_marshal_flags_wrap1(name){
   fn ${name}(any proxy, int opcode, any interface, int version, any flags, any arg0) any {
      #linux { return _c_wl_proxy_marshal_flags1(proxy, opcode, interface, version, flags, arg0) }
      #else { return 0 } #endif
   }
}
...
comptime template _wl_marshal_flags_wrap2(name){
   fn ${name}(any proxy, int opcode, any interface, int version, any flags, any arg0, any arg1) any {
      #linux { return _c_wl_proxy_marshal_flags2(proxy, opcode, interface, version, flags, arg0, arg1) }
      #else { return 0 } #endif
   }
}
...
comptime template _wl_marshal_flags_wrap3(name){
   fn ${name}(any proxy, int opcode, any interface, int version, any flags, any arg0, any arg1, any arg2) any {
      #linux { return _c_wl_proxy_marshal_flags3(proxy, opcode, interface, version, flags, arg0, arg1, arg2) }
      #else { return 0 } #endif
   }
}
...
comptime template _wl_marshal_flags_wrap4(name){
   fn ${name}(any proxy, int opcode, any interface, int version, any flags, any arg0, any arg1, any arg2, any arg3) any {
      #linux { return _c_wl_proxy_marshal_flags4(proxy, opcode, interface, version, flags, arg0, arg1, arg2, arg3) }
      #else { return 0 } #endif
   }
}
...
comptime template _wl_marshal_flags_wrap5(name){
   fn ${name}(any proxy, int opcode, any interface, int version, any flags, any arg0, any arg1, any arg2, any arg3, any arg4) any {
      #linux { return _c_wl_proxy_marshal_flags5(proxy, opcode, interface, version, flags, arg0, arg1, arg2, arg3, arg4) }
      #else { return 0 } #endif
   }
}
