...
mut _surface = 0 ;; malloc'd 8-byte buffer holding raw VkSurfaceKHR
mut _surface_handle = 0 ;; cached raw handle for truthiness checks
mut _swapchain = 0
...
mut _unlit_nocull_pipeline = 0
mut _mesh_opaque_pipeline = 0
mut _mesh_opaque_nocull_pipeline = 0
mut _mesh_opaque_nocull_flip_pipeline = 0
mut _mesh_opaque_unlit_pipeline = 0
mut _mesh_opaque_unlit_nocull_pipeline = 0
mut _mesh_opaque_unlit_nocull_flip_pipeline = 0
mut _mesh_alpha_pipeline = 0
mut _mesh_alpha_nocull_pipeline = 0
mut _mesh_alpha_nocull_flip_pipeline = 0
mut _mesh_alpha_unlit_pipeline = 0
mut _mesh_alpha_unlit_nocull_pipeline = 0
mut _mesh_alpha_unlit_nocull_flip_pipeline = 0
mut _mesh_alpha_flip_pipeline = 0
mut _mesh_alpha_unlit_flip_pipeline = 0
mut _mesh_fast_opaque_pipeline = 0
mut _mesh_fast_opaque_nocull_pipeline = 0
mut _mesh_fast_opaque_flip_pipeline = 0
mut _mesh_fast_opaque_nocull_flip_pipeline = 0
mut _mesh_fast_env_opaque_pipeline = 0
mut _mesh_fast_env_opaque_nocull_pipeline = 0
mut _mesh_fast_env_opaque_flip_pipeline = 0
mut _mesh_fast_env_opaque_nocull_flip_pipeline = 0
mut _flip_pipeline = 0
mut _flip_unlit_pipeline = 0
mut _line_pipeline = 0
mut _point_pipeline = 0
mut _wire_pipeline = 0
mut _circle_pipeline = 0
mut _ring_pipeline = 0
mut _skybox_pipeline = 0
mut _skybox_ds_cache = 0 ;; cached DS for the skybox texture (bindless-mode workaround)
mut _skybox_ds_tex_id = -1 ;; tex_id the cached DS was created for
mut _vert_module = 0
mut _frag_module = 0
mut _frag_fast_module = 0
mut _frag_fast_env_module = 0
...
mut _capture_w = 0
mut _capture_h = 0
mut _static_mega_buffer = 0
mut _static_mega_memory = 0
mut _static_mega_capacity = 134217728
mut _static_mega_used = 0
mut _static_mega_index_buffer = 0
mut _static_mega_index_memory = 0
...
mut _sem_avail_slab  = 0
mut _sem_finish_slab = 0
mut _fences_slab     = 0
mut _cmd_bufs_slab   = 0
mut _ubo_ds_slab     = 0
mut _framebuffers_slab = 0 ;; allocated dynamically when swapchain image count is known
...
mut _frame_slab = 0
mut _svbo_slab = 0
mut _scene_capture_slab = 0
mut _scene_capture_src_bar = 0
mut _scene_capture_dst_bar = 0
mut _scene_capture_copy_region = 0
mut _readback_slab = 0
mut _readback_ai = 0
mut _readback_cb_p = 0
mut _readback_bi = 0
mut _readback_barrier = 0
mut _readback_region = 0
mut _readback_s_info = 0
mut _upload_cb = 0
mut _upload_alloc = 0
mut _upload_bi = 0
mut _upload_bar1 = 0
