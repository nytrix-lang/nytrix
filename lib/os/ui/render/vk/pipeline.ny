;; Keywords: render vulkan gpu pipeline os ui
...
comptime emit _shader_cache_path_getter(_shader_sdf_line_spv, "nytrix_line.frag.spv")
...
fn create_pipeline(any vert_mod, any frag_mod, int topology=_VK_TOPO_TRIANGLES, int depth_test=1, int depth_write=1, int cull_mode=_VK_CULL_NONE, int front_face=_VK_FRONT_DEFAULT, int depth_bias=0, int depth_clamp=0, f64 line_width=1.0) any {
...
fn _create_graphics_layouts() bool {
   ...
   store32(pc_range, shader_pc_bytes(), 8)
...
fn _create_eager_mesh_pipelines() bool {
   ...
   _mesh_opaque_pipeline = _create_mesh_pipeline_with_frag(_frag_module, false, false, false)
   _mesh_opaque_nocull_pipeline = _create_mesh_pipeline_with_frag(_frag_module, false, true, false)
   _mesh_opaque_nocull_flip_pipeline = _create_mesh_pipeline_with_frag(_frag_module, false, true, true)
   _mesh_opaque_unlit_pipeline = _create_mesh_pipeline_with_frag(_frag_module, false, false, false)
   _mesh_opaque_unlit_nocull_pipeline = _create_mesh_pipeline_with_frag(_frag_module, false, true, false)
