;; Keywords: syntax helpers
;; Shared scanning primitives for syntax tokenizers and highlighters.
module std.parse.syntax.helpers(is_alpha_ch, is_digit_ch, is_alnum_ch, is_space_ch, word_eq, lower_ch, in_list, in_list_ci, add_tok, scan_space, scan_line, scan_quoted, scan_ident, char_in, scan_ident_extra, scan_number, tokenize_c_like)
use std.core
