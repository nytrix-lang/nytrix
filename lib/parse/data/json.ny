...
if(comptime{__main()}){
    ...
    assert(dict_get(err_invalid_lit, "ok", true) == false, "json error invalid literal")
    assert(dict_get(err_invalid_lit, "error", "") == "invalid literal", "json error msg invalid literal")
    ...
    assert(dict_get(err_invalid_surrogate, "ok", true) == false, "json error invalid surrogate")
    assert(dict_get(err_invalid_surrogate, "error", "") == "invalid unicode surrogate pair", "json error msg invalid surrogate")
