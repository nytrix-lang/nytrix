...
#main {
   ...
   assert(Q1[0] == 0 && Q1[1] == 1, "scalar mult by 1")
   ...
   def TE_Q2 = twisted_edwards_scalar_mult(2, TE_P, a2, d2, p2)
   assert(TE_Q2 == TE_P, "twisted mult 2 identity")
   print("✓ std.math.crypto.ecc.edwards self-test passed")
}
