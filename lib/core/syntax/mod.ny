...
fn get_attr_handler(name){
   ...
   return syntax_impl.get_attr_handler(__registry, name)
}
...
fn is_attr_registered(name){
   ...
   return syntax_impl.is_attr_registered(__registry, name)
}
...
fn apply_attribute(name, node, args=0){
   ...
   return syntax_impl.apply_attribute(__registry, name, node, args)
}
