...
def B64_CHARS = ascii.uppercase + ascii.lowercase + ascii.digits + "+/"
def B64_URL_CHARS = ascii.uppercase + ascii.lowercase + ascii.digits + "-_"
def B32_CHARS = ascii.uppercase + "234567"
def B32_HEX_CHARS = "0123456789ABCDEFGHIJKLMNOPQRSTUV"
def B16_CHARS = ascii.digits + "ABCDEF"
...
if(comptime{__main()}){
   ...
   print("✓ std.str.base tests passed")
}
