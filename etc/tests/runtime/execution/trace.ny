...
assert(__trace_loc("etc/tests/runtime/execution/trace.ny", 7, 3) == 0, "trace loc records source location")
assert(__trace_enter("rt.trace.test.enter", "etc/tests/runtime/execution/trace.ny", 8) == 0, "trace enter records call")
