...
assert(intrinsic("ctlz.i64", 1, false) == 63, "intrinsic(...) ctlz intrinsic failed")
assert(intrinsic("bswap.i32", 0x01020304) == 0x04030201, "intrinsic(...) bswap intrinsic failed")
assert(intrinsic("fshl.i64", 1, 1, 4) == 16, "intrinsic(...) fshl intrinsic failed")
