...
#include "etc/tests/interop/ffi/fficonsts.h"
#include "etc/tests/interop/ffi/transitive.h"
...
def c = cos(0.0)
assert(type(c) == "float" && c == 1.0, "FFI preserves native floating-point return values")
