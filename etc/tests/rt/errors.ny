...
assert(str_contains(capture(fn(){ append(id(1), 2) }), "append expects"), "receiver append should reject non-lists")
...
assert(did_catch(fn(){ append(id(1), 2) }), "receiver append should reject non-lists")
