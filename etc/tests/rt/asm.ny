...
;; Inline ASM
;; Exercises platform guards and per-arch inline assembly lowering.
def arch_name = arch() ; for runtime checks
...
#else {
   print("skip std.core.asm(unsupported arch: " + arch_name + ")")
}
