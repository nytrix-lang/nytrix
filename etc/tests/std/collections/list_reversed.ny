...
;; collections.list_reverse (Test)
;; Tests reversing lists of various lengths and types, including empty and single-element lists.
...
print("✓ std.collections.list_reverse tests passed")
